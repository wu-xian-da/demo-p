...
public class Reflections {
	...
	public static Object invokeMethodByName(final Object obj, final String methodName, final Object[] args) {
		Method method = getAccessibleMethdodByName(obj,methodName);
		if (method == null) {
			throw new IllegalArgumentException("Could not find method ["+methodName+"] on target ["+obj+"]");
		}
	 ...
	 * @return
	 */
	public static Method getAccessibleMethdodByName(final Object obj, final String methodName) {
		Validate.notNull(obj, "object can't be null");
		Validate.notNull(methodName,"methodName can't be blank");
	...
	/****
	 * 将反射的checked exception 转换为unchecked exception
	 * @param e
	 * @return
	 */
